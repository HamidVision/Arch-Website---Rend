...
const BorderCrossingPage: React.FC = () => {
      ...
      <div className="min-h-screen flex items-center justify-center px-8">
        ...
        >
          ...
          <p className="text-lg font-body text-white/50 mt-8 max-w-3xl mx-auto">
            This project explores architectural thresholds, spatial transitions, and the design 
            of boundary conditions that define and connect spaces.
          </p>
...
export default BorderCrossingPage;
